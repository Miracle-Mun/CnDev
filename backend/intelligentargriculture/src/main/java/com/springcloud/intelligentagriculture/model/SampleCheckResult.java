...
@Entity
@Table(name = "sample_check_result")
@EntityListeners(AuditingEntityListener.class)

public class SampleCheckResult implements Serializable {
    ...
    @NotNull
    @Length(max = 128, message = "*checkUnit must have at max 128 characters")
    ...
    @ApiModelProperty(value = "检测结果 (1:合格, 0:不合格)")
    @NotNull
    @Length(max = 16, message = "*checkResult must have at max 16 characters")
